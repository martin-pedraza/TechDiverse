...
class Usuario
{
    ...
    public function crearUsuario()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta(
            "INSERT INTO usuario (id, perfil, sector, nombre, operaciones, fechaRegistro, clave) 
            VALUES (:id, :perfil, :sector, :nombre, :operaciones, :fechaRegistro, :clave)"
            );
    ...
    public static function validarUsuario($nombre){
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta(
            "SELECT id, perfil, sector, nombre, operaciones, fechaRegistro, fechaSuspension, clave 
            FROM usuario
            WHERE nombre = :nombre AND fechaSuspension IS NULL;");
