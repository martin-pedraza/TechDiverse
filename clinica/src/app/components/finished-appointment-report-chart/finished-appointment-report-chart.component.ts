...
@Component({
  selector: 'app-finished-appointment-report-chart',
  templateUrl: './finished-appointment-report-chart.component.html',
  styleUrls: ['./finished-appointment-report-chart.component.css'],
})
export class FinishedAppointmentReportChartComponent
